    ...
    <div class="modal-content">
      ...
      <div class="alert alert-info" role="alert">
        All required fields are marked red
          ...
          <!-- EDIT INVENTORY FORM  -->
          <form class="edit-inventory-form" id="editInventoryForm">
            <input type="hidden"  name="computerID" id="computerID"  value="1" />
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="submitEditInventory">Go!</button>
      </div>
    </div>
  </div>
</div>